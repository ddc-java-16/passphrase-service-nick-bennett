...
public class AttachmentController {
  ...
  Iterable<Attachment> get(@PathVariable UUID passphraseKey) {
    return attachmentService.readAll(userService.getCurentUser(), passphraseKey);
  }
  ...
  Attachment get(@PathVariable UUID passphraseKey, @PathVariable UUID attachmentKey) {
    return attachmentService.read(userService.getCurentUser(), passphraseKey, attachmentKey);
  }
  ...
  public ResponseEntity<Resource> getContent(@PathVariable UUID passphraseKey, @PathVariable UUID attachmentKey) {
    Attachment attachment =
        attachmentService.read(userService.getCurentUser(), passphraseKey, attachmentKey);
    Resource resource = attachmentService.readContent(userService.getCurentUser(), passphraseKey, attachmentKey);
  ...
  public ResponseEntity<Attachment> post(
    ...
    Attachment attachment = attachmentService.store(userService.getCurentUser(), passphraseKey, file);
  ...
  public void delete(@PathVariable UUID passphraseKey, @PathVariable UUID attachmentKey) {
    attachmentService.delete(userService.getCurentUser(), passphraseKey, attachmentKey);
  }
